                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        ...
                                        <p class="info">
                                            ...
                                            <?php echo $sistema->sistema_texto;?>
                                        </p>
                                    </div>
                                    <ul class="des">
                                        ...
                                        <li>
                                            <span>Endereço: </span>
            <?php echo $sistema->sistema_endereco. ', nº - '.$sistema->sistema_numero. ' <br> CEP - ' .$sistema->sistema_cep. '<br>'.$sistema->sistema_cidade.' - '.$sistema->sistema_estado;
                                        ...
                                        <li>
                                            ...
                                            <a href="#"><?php echo $sistema->sistema_telefone_movel;?></a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
        ...
        <?php if(isset($scripts)) :?>
            <?php foreach ($scripts as $script):?> 
                    <script src="<?= base_url('public/assets/'.$script);?>"></script> 
            <?php endforeach; ?>
        <?php endif; ?>
