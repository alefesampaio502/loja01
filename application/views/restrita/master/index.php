    ...
    <?php $this->load->view('restrita/layout/sidebar');?>
     ...
     <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header d-block">
                        ...
                        <a href="<?php echo base_url('restrita/master/core');?>" class="btn btn-success float-right">Cadastrar</a>
                        </h4>
                      </div>
                      <div class="card-body">
                          ...
                          <table class="table table-striped data-table" >
                            <thead>
                              <tr>
                                ...
                                <th class="nosort">Nome da marca</th>
        ...
        <td><i data-feather="link-2" class="text-success mr-2"></i><?php echo $pai->categoria_pai_meta_link;?></td>
       <td><?php echo (formata_data_banco_com_hora($pai->categoria_pai_data_criacao));?></td>
                                
                                <td>
                                  <?php if($pai->categoria_pai_ativa == 1) :?>
                                ...
                                <td class="text-center"><a href="<?= base_url('restrita/master/core/'.$pai->categoria_pai_id)?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                                	<a href="<?php echo base_url('restrita/master/delete/'.$pai->categoria_pai_id);?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exlusão?"><i class="fas fa-user-times"></i></a></td>                       
                                  </tr>
