<?php $sistema = info_header_footer();?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="header-top-left">
                                <ul class="phone-wrap">
                                    <li><span>Nossos telefones: </span><a href="#"><?php echo $sistema->sistema_telefone_movel .$sistema->sistema_telefone_fixo;?></a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <li><a href="<?php echo base_url('marca/'. $marca->marca_meta_link);?>">
                <?php echo $marca->marca_nome ?></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                            ...
                            <?php  echo form_open('busca', $atributos);?>
                                ...
                                <input type="text" name="busca" placeholder="O que você tá procurando?">
                                    ...
                                    <li class="hm-minicart">
                                        ...
                                        <div class="minicart">
                                            <ul class="minicart-product-list">
                                                ...
                                                <li>
                                                    <a href="single-product.html" class="minicart-product-image">
                                                        <img src="<?php echo base_url();?>public/web/images/product/small-size/6.jpg" alt="cart products">
                                                    </a>
                                                    <div class="minicart-product-details">
                                                        <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                                                        <span>£40 x 1</span>
...
<?php $categorias_filhas = categorias_filhas_navbar($cat_pai->categoria_pai_id);?>
 <li class="dropdown-holder"><a href="<?php echo base_url('master/'.$cat_pai->categoria_pai_meta_link);?>"><?php echo $cat_pai->categoria_pai_nome;?></a>
    <ul class="hb-dropdown">
        ...
        <li class="active">
<a href="<?php echo base_url('categoria/'.$cat_filhas->categoria_meta_link); ?>">
            <?php echo $cat_filhas->categoria_nome;?></a></li>
                    <?php endforeach;?>     
                        </ul>
                            </li>
                              <?php endforeach;?>
