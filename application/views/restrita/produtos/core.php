              ...
              <div class="form-group col-md-2">
                ...
                <select class="form-control" name="produto_categoria_id">
                  ...
                  <?php foreach ($categorias as $categoria):?>
                   ...
                   <?php if(isset($produto)):?>
                    <option value="<?php echo $categoria->categoria_id;?>"<?php echo($categoria->categoria_id == $categoria->categoria_id ?'selected' : '')?>> <?php echo $categoria->categoria_nome;?></option>
                ...
                <div class="form-group col-md-2">
                  ...
                  <select class="form-control" name="produto_marca_id">
                    ...
                    <?php foreach ($marcas as $marca):?>
                     ...
                     <?php if(isset($produto)):?>
                      <option value="<?php echo $marca->marca_id;?>"<?php echo ($marca->marca_id == $marca->marca_id ?'selected' : '')?>> <?php echo $marca->marca_nome;?></option>
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <select class="form-control" name="produto_ativo">
                      ...
                      <?php if(isset($produto)):?>
                        ...
                        <option value="1"<?php echo($produto->produto_ativo == 1 ? 'selected' : 'selecione') ?> >Sim</option>
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <select class="form-control" name="produto_destaque">
                        ...
                        <?php if(isset($produto)):?>
                          ...
                          <option value="1"<?php echo($produto->produto_destaque == 1 ? 'selected' : 'selecione') ?> >Sim</option>
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <select class="form-control" name="produto_controlar_estoque">
                          ...
                          <?php if(isset($produto)):?>
                            ...
                            <option value="1"<?php echo($produto->produto_controlar_estoque == 1 ? 'selected' : 'selecione') ?> >Sim</option>
                      ...
                      <div class="form-row">
                            ...
                            <div id="uploaded_image" class="text-danger">
                              ...
                              <?php foreach ($fotos_produto as $foto):?>
                                ...
                                <ul style="list-style: none; display: inline-block;">
                                  ...
                                  <li>                                   
                                    <img src="<?php echo base_url('uploads/produtos/'.$foto->foto_caminho); ?>" width="80"
                                    class="img-thumbnail mr-1 mb-2">
                       ...
                       <div class="form-row">                      
                        <div class="form-group col-md-12">
                          ...
                          <textarea class="form-control" name="produto_descricao" rows="2" style="min-height:100px;">
                      ...
                      <div class="card-footer">
                        <div class=" mb-5" style="float:right;">
                          ...
                          <a class="btn btn-dark float-left mr-2" href="<?php echo base_url('restrita/produtos/');?>">Voltar</a>
                        </div>
                      </div>
                      <?php echo form_close(); ?>
                    </div>
