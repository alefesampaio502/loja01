...
<?php $this->load->view('web/layout/navbar');?>
   ...
   <img src="<?php echo base_url('uploads/produtos/'.$produto->foto_caminho);?>" alt="<?php echo word_limiter($produto->produto_nome, 100); ?>">
                                                </a>
    ...
    <h4><a class="product_name" href="single-product.html"><?php echo word_limiter($produto->produto_nome, 100); ?></a></h4>
                                                    <div class="price-box">
