<?php $this->load->view('web/layout/navbar');?>
    ...
    <span class="product-details-ref">Código: <?php echo $produto->produto_codigo ;?></span>
     ...
     <p class="mt-10"><span class="product-details-ref">Marca:&nbsp;<a href="<?php echo base_url('marca/'.$produto->marca_meta_link);?>"></a> <?php echo $produto->marca_nome;?></span></p>

     <p class="mt-10"><span class="product-details-ref">Estoque:&nbsp;
<?php echo ($produto->produto_quantidade_estoque > 0 ? '<span class="badge badge-success p-20" stayle="font-size:14px">'.$produto->produto_quantidade_estoque.'</span>' : '<span class="badge badge-danger" font-size:18px;>Produto Indisponível</span>');?>
                                    ...
                                    <div class="single-add-to-cart mt-10">
                                    ...
                                    <div class="single-add-to-cart mt-10">
                                        <form action="#" class="cart-quantity">
                                            ...
                                            <button class="add-to-cart" type="submit"><span style="font-size: 18px;"><i class="fa fa-cart-arrow-down text-red mr-2"></i></span>Adicionando ao carrinho</button>
                                        </form>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#description"><span>Descrição do produto</span></a></li>
